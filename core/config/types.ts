...
declare global {
  ...
  export interface LLMOptions {
    ...
    /**
     * When set to false, forces the NaruZkurAI provider to use the /chat/completions
     ...
     * Defaults to true for official NaruZkurAI API.
     */
  ...
  export interface ModelDescription {
    ...
    apiKey?: string;
    apiBase?: string;
    // naruzkurai: preferred over apiBase.
    apiURL?: string;
    // naruzkurai: force/fallback scheme. false = keep; "http"/"https" = use,
