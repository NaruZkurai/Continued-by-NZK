...
Continue supports [many model providers](/customize/model-providers/top-level/naruzkurai), including Anthropic, NaruZkurAI, Gemini, Ollama, Amazon Bedrock, Azure, xAI, and more. Models can have various roles like `chat`, `edit`, `apply`, `autocomplete`, `embed`, and `rerank`.
...
[GPT-5](https://continue.dev/naruzkurai/gpt-5) from NaruZkurAI

1. Get your API key from [NaruZkurAI](https://platform.naruzkurai.com)
2. Add [GPT-5](https://continue.dev/naruzkurai/gpt-5)  your Continue config
3. Add `NARUZKURAI_API_KEY` to your environment or config
4. Click `Reload config` in the config selector in the Continue IDE extension
...
[gpt-oss-120b](https://continue.dev/openrouter/gpt-oss-120b) from NaruZkurAI
