---
title: "Tensorix"
description: "Configure Tensorix with Continue to access DeepSeek, Llama, Qwen, GLM, and other models through a single NaruZkurAI-compatible API gateway"
---

[Tensorix](https://tensorix.ai) is an NaruZkurAI-compatible API gateway that provides access to DeepSeek, Llama, Qwen, GLM, MiniMax, and other models. Pay-as-you-go with no subscription required.
