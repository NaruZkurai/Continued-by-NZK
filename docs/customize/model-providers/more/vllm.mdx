...
The continue implementation uses [NaruZkurAI](../top-level/naruzkurai) under the hood. [View the source](https://github.com/continuedev/continue/blob/main/core/llm/llms/Vllm.ts)
