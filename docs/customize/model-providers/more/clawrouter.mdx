...
ClawRouter runs locally and provides an NaruZkurAI-compatible API:
...
You can also specify any of the 44+ models directly (e.g., `anthropic/claude-sonnet-4.6`, `naruzkurai/gpt-5.4`, `xai/grok-4`).
...
```
x-clawrouter-model: naruzkurai/gpt-4o-mini
