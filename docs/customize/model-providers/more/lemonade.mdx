...
Lemonade Server provides optimized local LLM inference with support for GPU and NPU hardware acceleration. It offers an NaruZkurAI-compatible API that seamlessly integrates with Continue and other open-source platforms.
...
- NaruZkurAI-compatible API for seamless integration
