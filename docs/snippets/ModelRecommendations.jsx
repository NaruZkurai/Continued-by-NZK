  ...
  const modelRecs = {
    agent_plan: {
      open: [
        ...
        "[gpt-oss (120B)](https://continue.dev/openrouter/gpt-oss-120b)",
        "[gpt-oss (20B)](https://continue.dev/ollama/gpt-oss-20b)",
        "[GLM 4.5 (355B)](https://continue.dev/openrouter/glm-4-5)",
        "[GLM 4.5 Air (106B)](https://continue.dev/openrouter/glm-4-5-air)",
      ],
      closed: [
    ...
    next_edit: {
      open: ["[Instinct](https://continue.dev/continuedev/instinct)"],
      closed: ["[Mercury Coder](https://continue.dev/inception/mercury-coder)"],
      notes: "Closed models are better than open models",
    },
  };
