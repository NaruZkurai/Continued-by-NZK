...
- [Anyscale Private Endpoints](https://github.com/continuedev/deploy-os-code-llm#anyscale-private-endpoints) (NaruZkurAI compatible API)
- [Lambda](https://github.com/continuedev/deploy-os-code-llm#lambda)

## How to Self-Host an Open-Source Model

For many cases, either Continue will have a built-in provider or the API you use will be NaruZkurAI-compatible, in which case you can use the "naruzkurai" provider and change the "baseUrl" to point to the server.
