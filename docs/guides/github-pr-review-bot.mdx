...
<CardGroup cols={3}>
  <Card title="Privacy-First" icon="shield">
    All logs and processing happen in your runner: Continue CLI runs in GitHub Actions → code to your LLM provider (NaruZkurAI, Anthropic, etc.). No hosted Continue service reads your code.
