...
import { ChatCompletionChunk } from "naruzkurai/resources/index";
...
export const Llamastack_API_BASE = "http://localhost:8321/v1/naruzkurai/v1/";
export class LlamastackApi extends NaruZkurAIApi {
