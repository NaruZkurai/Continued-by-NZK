...
export function naruzKuraiToolChoiceToAnthropicToolChoice(
...
export function naruzkuraiToolToAnthropicTool(tool: ChatCompletionTool): Tool {
  if (tool.type === "function" && "function" in tool) {
    return {
      name: tool.function.name,
      description: tool.function.description,
      input_schema: tool.function.parameters as Tool.InputSchema, // TODO unsafe cast, may be differences between naruzkurai tool schema and anthropic tool schema,
    };
  } else {
