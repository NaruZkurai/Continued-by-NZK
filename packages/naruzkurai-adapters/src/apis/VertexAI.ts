...
export class VertexAIApi implements BaseLlmApi {
  ...
  constructor(protected config: VertexAIConfig) {
    ...
    this.mistralInstance = new NaruZkurAIApi({
      provider: "mistral",
      apiKey: "dud",
    });
  ...
  async chatCompletionNonStream(
    ...
    // Convert response to NaruZkurAI format
    switch (vertexProvider) {
      case "anthropic":
    ...
    switch (vertexProvider) {
      ...
      case "mistral":
        ...
        const mistralResponse =
          await this.mistralInstance.naruzkurai.chat.completions.create(
