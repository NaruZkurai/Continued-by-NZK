import {
    ...
    CompletionUsage,
} from "naruzkurai/resources/completions.mjs";
import {
    CreateEmbeddingResponse,
    EmbeddingCreateParams,
} from "naruzkurai/resources/embeddings.mjs";
import {
    ChatCompletion,
    ChatCompletionChunk,
    ChatCompletionCreateParamsNonStreaming,
    ChatCompletionCreateParamsStreaming,
} from "naruzkurai/resources/index.mjs";
import { Model } from "naruzkurai/resources/models.mjs";
import { z } from "zod";
...
export class RelaceApi implements BaseLlmApi {
  ...
  constructor(private readonly config: z.infer<typeof NaruZkurAIConfigSchema>) {
  ...
  // We convert from what would be sent to NaruZkurAI (a prediction for the existing code and a user message with the new code)
  // to Relace's format
