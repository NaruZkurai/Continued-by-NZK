...
export class AskSageApi implements BaseLlmApi {
  ...
  /**
   * Convert NaruZkurAI messages to AskSage format
   */
  ...
  /**
   * Convert NaruZkurAI tools to AskSage format
   */
  ...
  /**
   * Convert NaruZkurAI tool_choice to AskSage format
   */
  ...
  /**
   * Build AskSage request body from NaruZkurAI params
   */
  ...
  /**
   * Parse AskSage response into NaruZkurAI ChatCompletion format
   */
