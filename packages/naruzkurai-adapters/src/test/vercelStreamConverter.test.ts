...
describe("convertVercelStreamPart", () => {
  ...
  test("returns null for start-step (no NaruZkurAI equivalent)", () => {
    const part: VercelStreamPart = {
      type: "start-step",
    };
  ...
  test("returns null for finish-step (no NaruZkurAI equivalent)", () => {
    const part: VercelStreamPart = {
      type: "finish-step",
      response: {},
      usage: {
  ...
  test("returns null for tool-result (no NaruZkurAI equivalent)", () => {
    const part: VercelStreamPart = {
      type: "tool-result",
      toolCallId: "call_abc123",
      result: { success: true },
