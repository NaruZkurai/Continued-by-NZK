/**
 * Converts Vercel AI SDK stream events to NaruZkurAI ChatCompletionChunk format
 */

import type { ChatCompletionChunk } from "naruzkurai/resources/index";
...
/**
 * Converts a Vercel AI SDK stream event to NaruZkurAI ChatCompletionChunk format.
 * Returns null for events that don't map to NaruZkurAI chunks (like step-start, step-finish, etc.)
 */
export function convertVercelStreamPart(
  ...
  switch (part.type) {
    ...
    case "tool-input-start":
      // Emit the initial chunk with id and function name, matching NaruZkurAI's
...
/**
 * Async generator that converts Vercel AI SDK stream to NaruZkurAI ChatCompletionChunk stream
 */
