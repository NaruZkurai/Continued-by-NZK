...
NaruZkurAI adapters convert an NaruZkurAI-compatible request to a request for another API and back.
...
- Keeping a private variable with anything that is already passed through the NaruZkurAI request body
